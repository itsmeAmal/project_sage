 ...
 * @author root_user
 */
public class test_ extends javax.swing.JFrame {

    /**
     * Creates new form test_
     */
    public test_() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        System.out.println(sdf.format(Validations.getSqlDateByUtilDate(dateChooserFromDate4.getDate())));
        System.out.println(Validations.getSqlDateByUtilDate(dateChooserFromDate4.getDate()).getTime());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(test_.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
